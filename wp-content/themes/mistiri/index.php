...
if(isset($theme_option['blog_page_bg_img']) && !empty($theme_option['blog_page_bg_img'])) $blogBG = $theme_option['blog_page_bg_img']['url'];

?>



	<div class="breadcrumb-section image-bg" style="background-image: url(<?php echo (!empty($blogBG))? $blogBG : ''; ?>) !important;">
        ...
        <div class="breadcrumb-content">
            ...
            <div class="container text-center">
            	...
            	<?php if(isset($theme_option['blog_page_title']) && !empty($theme_option['blog_page_title'])) : ?>

                <h1><span><?php echo  $theme_option['blog_page_title'];?></span></h1>

            	<?php endif; ?>

            	<?php if(isset($theme_option['blog_page_subtitle']) && !empty($theme_option['blog_page_subtitle'])) : ?>

                <p><?php echo esc_attr($theme_option['blog_page_subtitle']);?></p>
										...
										<div class="entry-meta">
											...
											<ul class="list-inline">
												...
												<?php endif; ?>
											   	...
											   	<li><a href="<?php the_permalink();?>"><i class="fa fa-comment-o"></i><?php comments_popup_link(__(' 0 comment','mistiri'),__(' 1 comment','mistiri'),__(' % comment','mistiri')); ?></a>
											   	</li>
										   </ul>
